...
class CrawlUnitTest(unittest.TestCase):
    ...
    def test_crawl_an_invalid_url(self):
        ...
        crawl_unit.crawl()
        self.assertTrue('text/html' in crawl_unit.content_type)
    ...
    def test_crawl_valid_image_url(self):
        crawl_unit = CrawlUnit("https://avatars3.githubusercontent.com/u/15319686", "https://avatars3.githubusercontent.com/u/15319686", 0)
        crawl_unit.crawl()
